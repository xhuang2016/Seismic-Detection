...
> To reproduce the results, please visit [NIED](http://www.kyoshin.bosai.go.jp/kyoshin/data/index_en.html), sign in, and select Network -- K-NET; Peak acceleration -- from 100 to 10000. Due to the limitation of the website, please select Recording start time annually.
